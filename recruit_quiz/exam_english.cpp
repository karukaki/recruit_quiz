...
QuestionList CreateEnglishPhraseExam()
{
	const struct {
		...
		3, { 2, 3, 4 }},
		{ "be going to[A]", "[A]するつもりだ", "	I am going to visit Osaka.", "大阪に行くつもりだ。",2, { 3, 5 }},
		{ "turn to[A] for[B]", "[A]に[B]を求める", "	She turn to the friends for help.", "彼女は友達に助けを求めた。",2, { 3, 5 }},
		{ "it is not until[A] that[B]", "[A]して初めて[B]する", "	It was not until dawn that the trouble solved.", "夜明けまで問題は解決しなかった。",2, { 3, 5 }},
		{ "[A] as well as[B]", "[B]だけでなく[A]も", "	He can speak French as well as English.", "彼は英語だけでなくフランス語も話せる。",2, { 3, 5 }},
		{ "[A] remain[B]", "[A]が[B]のままでいる", "	She remained silent.", "彼女は黙っていた。",2, { 3, 5 } },
		{ "both[A] and [B]", "[A]と[B]の両方とも", "	This bag is both quality and cheap.", "このかばんは品質が良いうえに安い。",2, { 3, 5 } },
		{ "either[A] or [B]", "[A]か[B]のどちらか", "	Mom says that you can have either a dog or a cat.", "母は、犬か猫のどちらかなら飼ってもいいと言っている。",2, { 3, 5 } },
		{ "neither[A] nor[B]", "[A]も[B]も両方ともない", "	We have neither the time nor the resources.", "我々には時間も資源もない。",2, { 3, 5 }},
		{ "not only[A] but also[B]", "[A]だけでなく[B]も", "	He likes not only movies but also books.", "彼は映画だけでなく本も好きだ。",2, { 3, 5 }},
		{ "take care of[A]", "[A]の世話をする", "	She always takes care of her sister.", "彼女はいつも妹の面倒を見ている。",2, { 3, 5 }},
		};
